...
const appHead = {"meta":[{"charset":"utf-8"},{"name":"viewport","content":"width=device-width, initial-scale=1"},{"name":"description","content":"Nisa Sakar, kişiye özel beslenme programları ile sağlıklı yaşam yolculuğuna adım atmanızı sağlar. Diyetisyenlik hizmeti ile sağlıklı kilo kontrolü ve dengeli beslenme."}],"link":[{"rel":"canonical","href":"https://nisasakar.com"}],"style":[],"script":[],"noscript":[],"htmlAttrs":{"lang":"tr"}};
