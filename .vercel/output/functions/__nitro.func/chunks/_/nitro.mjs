...
const _OY2Y2mM8Fl = defineNitroPlugin(async (nitroApp) => {
...
const _F7sfeK8rhF = defineNitroPlugin(async (nitroApp) => {
...
const _IPl7qQ = defineEventHandler(async (e) => {
...
const _eJlTnc = defineEventHandler(async (e) => {
...
const _exyGMd = defineEventHandler(async (e) => {
...
const _daS42B = defineEventHandler(async (e) => {
...
const _inlineRuntimeConfig = {
  "app": {
    "baseURL": "/",
    "buildId": "f4b07740-155e-46af-ae92-209aafdb2996",
...
storage.mount('data', unstorage_47drivers_47fs_45lite({"driver":"fsLite","base":"C:\\Users\\Hp\\Desktop\\Projects\\SiteOfDietician\\.data\\kv"}));
...
const _LbQS3W = defineEventHandler(async (e) => {
...
const _lazy_TqdbKo = () => import('../routes/renderer.mjs');

const handlers = [
  { route: '/__nuxt_error', handler: _lazy_TqdbKo, lazy: true, middleware: false, method: undefined },
  { route: '', handler: _IPl7qQ, lazy: false, middleware: true, method: undefined },
  { route: '/robots.txt', handler: _eJlTnc, lazy: false, middleware: false, method: undefined },
  { route: '', handler: _exyGMd, lazy: false, middleware: true, method: undefined },
  { route: '/__sitemap__/style.xsl', handler: _daS42B, lazy: false, middleware: false, method: undefined },
  { route: '/sitemap.xml', handler: _LbQS3W, lazy: false, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_TqdbKo, lazy: true, middleware: false, method: undefined }
];
...
export { $fetch as $, publicAssetsURL as a, buildAssetsURL as b, createError$1 as c, defineRenderHandler as d, getRouteRules as e, useRuntimeConfig as f, getQuery as g, getResponseStatusText as h, getResponseStatus as i, hasProtocol as j, isScriptProtocol as k, joinURL as l, getContext as m, baseURL as n, createHooks as o, parseQuery as p, toRouteMatcher as q, createRouter$1 as r, sanitizeStatusCode as s, toNodeListener as t, useNitroApp as u, defu as v, withQuery as w, withTrailingSlash as x, withoutTrailingSlash as y };
