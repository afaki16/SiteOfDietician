...
import { j as hasProtocol, k as isScriptProtocol, l as joinURL, w as withQuery, s as sanitizeStatusCode, m as getContext, $ as $fetch, n as baseURL, o as createHooks, c as createError$1, q as toRouteMatcher, r as createRouter$1, v as defu } from '../_/nitro.mjs';
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import('./index-CpudTGMa.mjs')
  }
];
...
const layouts = {
  default: defineAsyncComponent(() => import('./default-BHuDH2vy.mjs').then((m) => m.default || m))
};
